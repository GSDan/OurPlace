...
namespace OurPlace.API.Controllers.Site
{
    ...
    public class AccountController : Controller
    {
        ...
        public string GetCurrentUserFirstName()
        {
            ...
            return (user != null) ? user.FirstName : User.Identity.Name;
        }
        ...
        {
            var user = UserManager.FindByEmail(User.Identity.GetUserName());
            string avatarUrl = ConfidentialData.defaultAvatarUrl;
        ...
        public ApplicationSignInManager SignInManager
        {
            get
            {
                if (_signInManager != null) return _signInManager;
   ...
   OAuthDefaults.AuthenticationType);
        ...
        ////        ApplicationUser user = await UserManager.FindAsync(new UserLoginInfo(loginInfo.Login.LoginProvider,
