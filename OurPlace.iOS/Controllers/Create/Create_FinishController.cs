...
namespace OurPlace.iOS
{
    public partial class Create_FinishController : UIViewController, IPlacePickerViewControllerDelegate
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            if (editingSubmitted)
            {
                isPublicSwitch.On = thisActivity.IsPublic;
                reqNamesSwitch.On = thisActivity.RequireUsername;

                if (thisActivity.Places != null && thisActivity.Places.Any())
                {
                    chosenPlace = thisActivity.Places.First();
